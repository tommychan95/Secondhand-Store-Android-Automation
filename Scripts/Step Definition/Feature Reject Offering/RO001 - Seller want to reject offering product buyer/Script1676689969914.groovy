...
Mobile.waitForElementPresent(findTestObject('Page_Reject Offering/ImageView_DaftarJualSaya'), 5)
...
WebUI.callTestCase(findTestCase('Pages/Reject Offering/Click Button Tolak'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.getText(findTestObject('Page_Reject Offering/TextView-Penawaranditolak'), 0)

...
WebUI.callTestCase(findTestCase('Pages/Register/Navigate to Register page'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Pages/Register/Input address'), [:], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyMatch(errorText, 'Nomor telepon tidak boleh kosong', false)

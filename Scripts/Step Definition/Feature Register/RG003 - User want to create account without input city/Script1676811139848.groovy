...
Mobile.callTestCase(findTestCase('Pages/Register/Input phone number'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Register/Input address'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.scrollToText('Sudah punya akun?', FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Register/Tap button register'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.tapAtPosition(150, 200)

errorText = Mobile.getText(findTestObject('Page_Register/register_error_text'), 0)

Mobile.verifyMatch(errorText, 'Kota tidak boleh kosong', false)

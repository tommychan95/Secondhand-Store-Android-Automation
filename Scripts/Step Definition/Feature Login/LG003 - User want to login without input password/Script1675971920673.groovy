...
Mobile.callTestCase(findTestCase('Pages/User Login/Input email'), [('email') : 'asdfg@gmail.com'], FailureHandling.STOP_ON_FAILURE)
...
Mobile.verifyElementVisible(findTestObject('Page_User Login/error_password_empty'), 0)

errorText = Mobile.getText(findTestObject('Page_User Login/error_password_empty'), 0)

Mobile.verifyMatch(errorText, 'Password tidak boleh kosong', false)

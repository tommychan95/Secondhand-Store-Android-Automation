...
Mobile.callTestCase(findTestCase('Pages/Profile/change name'), [('name') : ''], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Profile/tap submit button'), [:], FailureHandling.STOP_ON_FAILURE)

error_message = Mobile.getText(findTestObject('Page_Profile/input_edit_name'), 0)

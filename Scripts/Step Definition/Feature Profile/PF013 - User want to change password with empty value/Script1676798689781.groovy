...
error_message = Mobile.getText(findTestObject('Page_Profile/input_edit_new_password'), 0)

error_message = Mobile.getText(findTestObject('Page_Profile/input_edit_confirm_new_password'), 0)

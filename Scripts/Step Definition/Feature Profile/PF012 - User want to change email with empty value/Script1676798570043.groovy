...
Mobile.callTestCase(findTestCase('Pages/Profile/change email'), [('email') : ''], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Profile/tap submit button'), [:], FailureHandling.STOP_ON_FAILURE)

error_message = Mobile.getText(findTestObject('Page_Profile/input_edit_email'), 0)

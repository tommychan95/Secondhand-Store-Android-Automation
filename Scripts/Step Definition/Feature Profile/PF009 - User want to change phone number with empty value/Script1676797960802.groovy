...
Mobile.callTestCase(findTestCase('Pages/Profile/change phone number'), [('phone') : ''], FailureHandling.STOP_ON_FAILURE)

Mobile.callTestCase(findTestCase('Pages/Profile/tap submit button'), [:], FailureHandling.STOP_ON_FAILURE)

error_message = Mobile.getText(findTestObject('Page_Profile/input_phone_number'), 0)
